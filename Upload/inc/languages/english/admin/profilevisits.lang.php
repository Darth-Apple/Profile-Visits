...
$l['profilevisits_groups_desc'] = "Allows you to configure which usergroups will be logged on user profiles. Note that guests will never be displayed on the latest visitors list, but will still be counted if the guest usergroup is enabled.  ";
